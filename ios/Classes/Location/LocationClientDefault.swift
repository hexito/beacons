...
class LocationClientDefault : NSObject, CLLocationManagerDelegate {
...
//        let beaconManager = SBKBeaconManager();
//        
//        for beacon in beacons {
//            let beacon:SBKBeacon = beaconManager.beacon(with: beacon);
//            print(beacon.batteryLevel);
//        }
//        
//        requests
